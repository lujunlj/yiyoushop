...
public class SQLManager {
    ...
    public SQLManager(DBStyle dbStyle, SQLLoader sqlLoader, ConnectionSource ds, NameConversion nc,
        ...
        this(dbStyle, sqlLoader, ds, nc, inters, defaultSchema, new Properties(),1);
    }

    public SQLManager(DBStyle dbStyle, SQLLoader sqlLoader, ConnectionSource ds, NameConversion nc,
                      Interceptor[] inters, String defaultSchema, Properties ps,Integer logicDeleteValue) {
        this(dbStyle, sqlLoader, ds, nc, inters, defaultSchema, ps, dbStyle.getName(),logicDeleteValue);
    }
     ...
     */
    public SQLManager(DBStyle dbStyle, SQLLoader sqlLoader, ConnectionSource ds, NameConversion nc,
                      Interceptor[] inters, String defaultSchema, Properties ps, String name,Integer logicDeleteValue) {
        ...
        this.dbStyle.setLogicDeleteValue(logicDeleteValue);
