...
public class SpringBeetlSql {
	...
	protected Integer logicDeleteValue = 1;
	ConnectionSource cs;
	DBStyle dbStyle;
	SQLLoader sqlLoader;
	NameConversion nc;
	...
	public void init() {
		...
		sqlManager = new SQLManager(dbStyle, sqlLoader, cs, nc, interceptors, this.defaultSchema, properties,this.logicDeleteValue);
