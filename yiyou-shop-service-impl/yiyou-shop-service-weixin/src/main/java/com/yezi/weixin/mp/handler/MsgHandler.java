package com.yezi.weixin.mp.handler;

import com.yezi.core.constants.Constants;
import com.yezi.core.utils.RedisUtil;
import com.yezi.core.utils.RegexUtils;
import com.yezi.weixin.mp.builder.TextBuilder;
...
public class MsgHandler extends AbstractHandler {
    ...
    // 用户发送手机验证码提示
    @Value("${yiyou.weixin.registration.code.message}")
    private String registrationCodeMessage;
    // 默认用户发送验证码提示
    @Value("${yiyou.weixin.default.registration.code.message}")
